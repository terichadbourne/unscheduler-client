...
var addNestedValue = __webpack_require__(17);
...
var eventsUi = __webpack_require__(40);
var eventsApi = __webpack_require__(41);
...
var addHandlers = function addHandlers() {
  ...
  $('.hide-admin').on('click', function () {
    $('.admin-panel, .hide-admin').addClass('hidden');
    $('.show-admin').removeClass('hidden');
  });
};

var onGetEvent = function onGetEvent() {
  // make API call for the default (and only) event (id stored in config)
  eventsApi.getEvent(config.eventId).then(eventsUi.getEventSuccess).catch(eventsUi.getEventError);
};
...
var onUpdateStage = function onUpdateStage(event) {
  // grab previous data
  var data = setDefaultData();
  var newStage = $(event.target).data('id');
  ...
  eventsApi.updateEvent(data).then(eventsUi.updateEventSuccess).catch(eventsUi.updateEventError);
};
...
var getFormFields = __webpack_require__(7);
var discussionsUi = __webpack_require__(10);
var discussionsApi = __webpack_require__(12);
...
var onGetDiscussion = function onGetDiscussion(event) {
  var id = $(event.target).data('id');
  discussionsApi.getDiscussion(id).then(discussionsUi.refreshUpdateModal).catch(discussionsUi.getDiscussionError);
};

var onUpdateDiscussion = function onUpdateDiscussion(event) {
...
var onCreateDiscussion = function onCreateDiscussion(event) {
  // prevent page refresh
  event.preventDefault();
...
// refresh discussion list
var onGetDiscussions = function onGetDiscussions() {
  // send request to server
  discussionsApi.getDiscussions().then(discussionsUi.getDiscussionsSuccess).catch(discussionsUi.getDiscussionsError);
};
...
var showDiscussionsProposingTemplate = __webpack_require__(20);
var showDiscussionsVotingTemplate = __webpack_require__(37);
var showDiscussionsLoggedOutTemplate = __webpack_require__(38);
var updateFormTemplate = __webpack_require__(39);
var store = __webpack_require__(1);
var eventsEvents = __webpack_require__(8);

var getDiscussionsSuccess = function getDiscussionsSuccess(response) {
  ...
  if (store.user) {
    var revisedDiscussions = response.discussions.map(function (discussion) {
    ...
    if (response.discussions.length === 0) {
      ...
      var showDiscussionsVotingHtml = showDiscussionsVotingTemplate({ discussions: revisedDiscussions });
      var showDiscussionsProposingHtml = showDiscussionsProposingTemplate({ discussions: revisedDiscussions });
    ...
    if (response.discussions.length === 0) {
      ...
      var showDiscussionsLoggedOutHtml = showDiscussionsLoggedOutTemplate({ discussions: response.discussions });
...
var getDiscussionError = function getDiscussionError(error) {
  ui.showMessage('Error retrieving that particular session from database.');
};

var getDiscussionsError = function getDiscussionsError(error) {
  ui.showMessage('Error retrieving all sessions from database.');
};

var updateDiscussionError = function updateDiscussionError(error) {
  ui.showMessage('Error updating that discussion in database.');
};

var createDiscussionError = function createDiscussionError(error) {
  ui.showMessage('Error creating new discussion topic in database.');
  // clear values from proposal form
  $('#propose-topic-form > input').val('');
};

var deleteDiscussionError = function deleteDiscussionError(error) {
  ui.showMessage('Error deleting session from database.');
};

var refreshUpdateModal = function refreshUpdateModal(response) {
  var id = response.discussion.id;
  var updateFormHtml = updateFormTemplate({ discussion: response.discussion });
...
var createDiscussion = function createDiscussion(data) {
  return $.ajax({
    method: 'POST',
...
var updateDiscussion = function updateDiscussion(data) {
  return $.ajax({
    method: 'PATCH',
...
var getDiscussion = function getDiscussion(id) {
  if (store.user) {
    return $.ajax({
      method: 'GET',
      url: config.apiUrl + ('/discussions/' + id),
...
var getDiscussions = function getDiscussions() {
  if (store.user) {
    return $.ajax({
      method: 'GET',
      url: config.apiUrl + '/discussions/',
...
var discussionsEvents = __webpack_require__(9);
var votesEvents = __webpack_require__(42);
var eventsEvents = __webpack_require__(8);
...
var getFormFields = __webpack_require__(7);
var authApi = __webpack_require__(18);
var authUi = __webpack_require__(19);
...
var showAuthErrorMessage = function showAuthErrorMessage(message) {
  $('.auth-alert-modal').html(message).removeClass('hidden');
};

var showAuthSuccessMessage = function showAuthSuccessMessage(message) {
  $('.auth-alert-main').html(message).removeClass('hidden');
};

// remove message currently displayed to user
var clearAuthMessage = function clearAuthMessage() {
  $('.auth-alert-main').addClass('hidden').html('');
  $('.auth-alert-modal').addClass('hidden').html('');
};

// clear values from all auth forms
var clearAuthForms = function clearAuthForms() {
  $('input').val('');
};
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
  ...
  return "        <td><button class=\"update-topic\" data-toggle=\"modal\" data-target=\"#udpateTopicModal\" data-id=\""
    + container.escapeExpression(container.lambda(((stack1 = blockParams[1][0]) != null ? stack1.id : stack1), depth0))
    + "\" type=\"button\">Modify</button></td>\n";
  ...
  return "<tr>\n   <th></th>\n   <th>Session Topic</th>\n </tr>\n\n"
    + ((stack1 = helpers.each.call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? depth0.discussions : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "");
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
  ...
  return "\n    <tr data-id=\""
    ...
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.title : stack1), depth0))
    + "</td>\n      <td>"
    + alias2(alias1(((stack1 = ((stack1 = blockParams[0][0]) != null ? stack1.users : stack1)) != null ? stack1.length : stack1), depth0))
    + "</td>\n"
    + ((stack1 = helpers["if"].call(alias3,((stack1 = blockParams[0][0]) != null ? stack1.current_user_session_votes : stack1),{"name":"if","hash":{},"fn":container.program(2, data, 0, blockParams),"inverse":container.program(4, data, 0, blockParams),"data":data,"blockParams":blockParams})) != null ? stack1 : "")
    + ((stack1 = helpers["if"].call(alias3,((stack1 = blockParams[0][0]) != null ? stack1.can_upvote : stack1),{"name":"if","hash":{},"fn":container.program(6, data, 0, blockParams),"inverse":container.program(8, data, 0, blockParams),"data":data,"blockParams":blockParams})) != null ? stack1 : "")
    + ((stack1 = helpers["if"].call(alias3,((stack1 = blockParams[0][0]) != null ? stack1.can_downvote : stack1),{"name":"if","hash":{},"fn":container.program(10, data, 0, blockParams),"inverse":container.program(12, data, 0, blockParams),"data":data,"blockParams":blockParams})) != null ? stack1 : "")
    + "\n    </tr>\n\n";
},"2":function(container,depth0,helpers,partials,data,blockParams) {
    var stack1;

  return "        <td>"
    + container.escapeExpression(container.lambda(((stack1 = blockParams[1][0]) != null ? stack1.current_user_session_votes : stack1), depth0))
    + "</td>\n";
},"4":function(container,depth0,helpers,partials,data) {
    return "        <td>0</td>\n";
  ...
  return "        <td><button class=\"upvote\" data-id=\""
    + container.escapeExpression(container.lambda(((stack1 = blockParams[1][0]) != null ? stack1.id : stack1), depth0))
    + "\" type=\"button\">Add Vote</button></td>\n";
},"8":function(container,depth0,helpers,partials,data,blockParams) {
    var stack1;

  return "        <td><button class=\"upvote\" data-id=\""
    + container.escapeExpression(container.lambda(((stack1 = blockParams[1][0]) != null ? stack1.id : stack1), depth0))
    + "\" type=\"button\" disabled>Add Vote</button></td>\n";
},"10":function(container,depth0,helpers,partials,data,blockParams) {
    var stack1;

  return "          <td><button class=\"downvote\" data-id=\""
    + container.escapeExpression(container.lambda(((stack1 = blockParams[1][0]) != null ? stack1.id : stack1), depth0))
    + "\" type=\"button\">Remove Vote</button></td>\n";
},"12":function(container,depth0,helpers,partials,data,blockParams) {
    var stack1;

  return "          <td><button class=\"downvote\" data-id=\""
    + container.escapeExpression(container.lambda(((stack1 = blockParams[1][0]) != null ? stack1.id : stack1), depth0))
    + "\" type=\"button\" disabled>Remove Vote</button></td>\n";
},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data,blockParams) {
    var stack1;
...
module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
  ...
  return alias2(helpers.log.call(alias1,(depth0 != null ? depth0.discussion : depth0),{"name":"log","hash":{},"data":data}))
    + "\n"
    + alias2(helpers.log.call(alias1,((stack1 = (depth0 != null ? depth0.discussion : depth0)) != null ? stack1.title : stack1),{"name":"log","hash":{},"data":data}))
    + "\n<label for=\"title\">Proposed Session Topic</label>\n<input name=\"title\" value=\""
    + ((stack1 = alias3(((stack1 = (depth0 != null ? depth0.discussion : depth0)) != null ? stack1.title : stack1), depth0)) != null ? stack1 : "")
    + "\" type='text' data-id=\""
    + alias2(alias3(((stack1 = (depth0 != null ? depth0.discussion : depth0)) != null ? stack1.id : stack1), depth0))
    + "\" required/>\n";
},"useData":true});
...
var getEventSuccess = function getEventSuccess(response) {
  store.event = response.event;
  var eventStage = response.event.stage;
...
var getEventError = function getEventError(error) {
  ui.showMessage('Error getting event details from database.');
};

var updateEventError = function updateEventError(error) {
  ui.showMessage('Error updating event details in database.');
};

var updateEventSuccess = function updateEventSuccess(response) {
  store.event = response.event;
  $("input[name='name'], input[name='max_votes']").val('');
  $("input[name='name']").attr('placeholder', store.event.name);
  $("input[name='max_votes']").attr('placeholder', store.event.max_votes);
...
var showWinnersTemplate = __webpack_require__(43);
var getFormFields = __webpack_require__(7);
var discussionsUi = __webpack_require__(10);
var discussionsApi = __webpack_require__(12);
var votesUi = __webpack_require__(44);
var votesApi = __webpack_require__(45);
var store = __webpack_require__(1);
var ui = __webpack_require__(4);
...
var onDeleteVote = function onDeleteVote(event) {
  if (!store.user) {} else {
    var discussionId = $(event.target).data('id');
    var userId = store.user.id;
    var matchedDiscussion = store.discussions.find(function (discussion) {
      return discussion.id === discussionId;
    });
    // find the first vote for the current user which is for the session clicked
    var matchedVote = matchedDiscussion.votes.find(function (vote) {
      return vote.user_id === userId;
    });
    if (matchedVote) {
      var id = matchedVote.id;
...
// refresh discussion list
var onCreateVote = function onCreateVote(event) {
  // capture user credentials from form and send to server
  if (!store.user) {} else {
    var data = {};
    data.vote = {};
...
var pickWinners = function pickWinners(event) {
  event.preventDefault();
  var data = getFormFields(event.target);
  var slots = data.timeslots * data.rooms;
  discussionsApi.getDiscussions().then(function (response) {
    ...
    if (discussions.length <= slots) {
      ...
      var minVotesToWin = discussions[slots - 1].votes.length;
      proposedWinners = discussions.filter(function (discussion) {
        return discussion.votes.length >= minVotesToWin;
      });
      ...
      if (proposedWinners.length !== slots) {
        ...
        var tiedDiscussions = proposedWinners.filter(function (discussion) {
          return discussion.votes.length === minVotesToWin;
        }).length;
    ...
    var showWinnersHtml = showWinnersTemplate({ discussions: proposedWinners });
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
  ...
  return ((stack1 = helpers["if"].call(depth0 != null ? depth0 : (container.nullContext || {}),((stack1 = blockParams[0][0]) != null ? stack1.tied : stack1),{"name":"if","hash":{},"fn":container.program(2, data, 0, blockParams),"inverse":container.program(4, data, 0, blockParams),"data":data,"blockParams":blockParams})) != null ? stack1 : "")
    + "\n";
},"2":function(container,depth0,helpers,partials,data,blockParams) {
    var stack1, alias1=container.lambda, alias2=container.escapeExpression;
  ...
  return "      <tr data-id=\""
    ...
    + "\" class=\"tied table-primary\">\n        <td>❓</td>\n        <td>"
    + alias2(alias1(((stack1 = ((stack1 = blockParams[1][0]) != null ? stack1.votes : stack1)) != null ? stack1.length : stack1), depth0))
    + "</td>\n        <td>"
...
var createVoteError = function createVoteError(error) {
  ui.showMessage('Error creating new vote in database.');
};

var deleteVoteError = function deleteVoteError(error) {
  ui.showMessage('Error deleting vote from database.');
};

var pickWinnersError = function pickWinnersError(error) {
...
var createVote = function createVote(data) {
  return $.ajax({
    method: 'POST',
...
var deleteVote = function deleteVote(id) {
  return $.ajax({
    method: 'DELETE',
